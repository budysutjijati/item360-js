...
import { Decorator, SystemIcon, useDispatch, useLayoutEffect } from '@uif-js/core';
...
export default function DashboardPage({ items, dashboard }) {
				...
				<ScrollPanel orientation={ScrollPanel.Orientation.VERTICAL}>
					...
					>
						...
						<GridPanel.Item rowIndex={1} columnIndex={0} columnSpan={2}>
							<TopList title={'Most Expensive Items'} items={dashboard.topMostExpensive} loading={loading} />
						</GridPanel.Item>
